...
Entgegen der Intutition der meisten, besagt die Lösung des Ziegenproblemsvon vos Savos, man hätte eine Gewinnchance von \sfrac{2}{3} wenn man wechselt während man bei der ursprünglichen Wahl nur in \sfrac{1}{3} der Fälle das Auto gewinnt:
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics{tex/tree.pdf}}
